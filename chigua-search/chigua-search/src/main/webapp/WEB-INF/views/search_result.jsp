    ...
    <el-container>
        <el-header style="height: 30px">
            <div>
                ...
                &nbsp;&nbsp;|&nbsp;&nbsp;
                <a href="https://github.com/dengyuhan/magnetW/issues/new" target="_blank">反馈失效</a>
                |&nbsp;&nbsp;
                <a href="https://github.com/dengyuhan/magnetW/issues/new" target="_blank">提交网站</a>
            </div>
        </el-header>
        <el-main>
    ...
    new Vue({
        ...
        methods: {
            ...
            openDisclaimerDialog: function () {
                this.$alert('1:本网站完全开源，仅用于技术交流学习，用户使用本工具进行的任何操作，本服务器均不保存。<br/><br/>' +
                    '2:本网站不会存储，不能分享，也不提供任何传播信息与资源的功能, 对此工具的非法使用概不负责。<br/><br/>'
                    +'3:本网站搜出的资源均来自互联网，本站不产生任何内容信息', '免责声明', {
